...
const MATRIX = [
  ...
  ["planinfo:mind",    App,              { authStep: null, activeTab: "track", todayOnboarded: true, dailyState: "empty", planInfo: "mind" }],
  ...
  ["plan:wait:all",    App,              { authStep: null, activeTab: "track", todayOnboarded: true, kcalSource: "pending", movePlan: null, planInfo: "all" }],
  ...
  ["score:intro",      App,             { authStep: null, plan: "paid", todayOnboarded: true, scoreFlow: "intro" }],
  ["score:focus",      App,             { authStep: null, plan: "paid", todayOnboarded: true, scoreFlow: "focus" }],
  ["score:profile",    App,             { authStep: null, plan: "paid", todayOnboarded: true, scoreFlow: "profile", scoreStep: 2 }],
  ["score:review",     App,             { authStep: null, plan: "paid", todayOnboarded: true, scoreFlow: "review" }],
  ["score:working",    App,             { authStep: null, plan: "paid", todayOnboarded: true, scoreFlow: "working" }],
  ["score:result",     App,             { authStep: null, plan: "paid", todayOnboarded: true, scoreFlow: "result" }],
  ["live:one",         App,             { authStep: null, activeTab: "home", plan: "paid", todayOnboarded: true, homeProgramTab: "live" }],
  ["live:none",        App,             { authStep: null, activeTab: "home", plan: "paid", todayOnboarded: true, liveState: "none" }],
  ...
  ["meal:part:one",    App,              { authStep: null, activeTab: "track", todayOnboarded: true, kcalSource: "coach", movePlan: "assigned", rowMenu: "meal:breakfast", mealsLogged: [{ division: "breakfast", timeMins: 510, items: [{ id: "eggs", qty: 1 }] }] }],
