        ...
        {msDetail === "score" ? (
          ...
          <>
            ...
            {[
              ...
              { l: "Wellbeing and stress", d: "Stress, sleep quality and breathing", s: "1 of 3 measured" },
              { l: "Lab report results", d: "Upload a report and we will read it for you", s: "Upload a report" },
            ].map((c) => (
              <div
                key={c.l}
                style={{
